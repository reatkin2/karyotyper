...
public class Axis {
	...
	/**
	 * The lower distance acceptable to reasonably acquire an approximate tangent line for a point.
	 */
	private double tanLowerPrecision;
	/**
	 * The upper distance acceptable to reasonably acquire an approximate tangent line for a point.
	 */
	...
	/**
	 * Gets a point along the medial axis 5 points away from the requested point. It searches pixels
	 * around the requested point clockwise until another axis point is encountered. Then does so
	 * again 4 more times. If the final point is less than 5 points away then it searches again
	 * counterclockwise.
	 * 
	 * @param p
	 * @return
