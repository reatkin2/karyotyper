...
public class ClusterSplitterTest extends TestCase {
	...
	public void testGetQueenMoveLength(){
		...
		assertEquals(11,12-ClusterSplitter.getQueenMoveLength(myCluster, new Point(8,27), 4, 12));
		...
		assertEquals(12,12-ClusterSplitter.getQueenMoveLength(myCluster, new Point(8,27), 0, 12));
		...
		assertEquals(12,12-ClusterSplitter.getQueenMoveLength(myCluster, new Point(8,29), 0, 12));
