...
public class AroundPixel {
	...
	/**
	 * get a point that values can be added to another point to be 
	 * the adjacent position from the point you add the return point too
	 * @param pos the adjacent position starting with 0 at top center and moving
	 * 		counter clockwise
	 * @return point that values can be added to another point to be 
	 * the adjacent position from the point you add the return point too
	 */
	 ...
	 * @param pos  the adjacent position starting with 0 at top center and moving
	 * 		counter clockwise
	 * @param fromPoint the point that your trying to find an adjacent point of
	...
	/**
	 * returns true if the positions are adjacent based on 0 at the top
	 * and incrementing by 1 and rotating counter clockwise 0-7 
	 * @param pos1 a position around a point
	 * @param pos2 a position around a point
	 ...
	 * @param pos the number to be checked and returned
	...
	/**
	 * if the positions are oppisite corners it returns true 
	 * 
	 * @param pos1 position to be checked
	 * @param pos2 position to be checked
	 * @return true if the positions are oppisite corners
	 */
