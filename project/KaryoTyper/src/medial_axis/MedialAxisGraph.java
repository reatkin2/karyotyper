...
public class MedialAxisGraph {
	 ...
	 */
	private void removeVertex(LinkedList<Vertex> removeList) {
	...
	public LinkedList<Point> trimMedialAxis(int minDistance, LinkedList<Point> medialAxis,
